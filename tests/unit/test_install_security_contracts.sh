...
assert_contains "$ROOT_DIR/etc/polkit-1/rules.d/49-watchdogvpn-resolved.rules" 'action.id === "org.freedesktop.NetworkManager.settings.modify.system"' "polkit policy must authorize the NetworkManager system DNS restore action"
