...
assert_contains "$SERVICE" "AmbientCapabilities=CAP_NET_ADMIN CAP_NET_BIND_SERVICE CAP_NET_RAW CAP_SYS_PTRACE" "daemon unit must grant confirmed ambient capabilities"
assert_contains "$SERVICE" "CapabilityBoundingSet=CAP_NET_ADMIN CAP_NET_BIND_SERVICE CAP_NET_RAW CAP_SYS_PTRACE" "daemon unit must keep bounding set coherent with ambient capabilities"
